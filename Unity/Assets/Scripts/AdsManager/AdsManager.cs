...
public class AdsManager : MonoBehaviour {
	...
	public void IsVideoRewardAvailable()
	{
		if(isVideoAvaiable())
		{
			...
			if(GameData.bWatchVideoStart )  ShowVideoReward(0);
		}
		else
		{
			GameData.bWatchVideoReady = false;
			if(GameData.bWatchVideoStart )  Camera.main.SendMessage("FinishWatchingVideoError",true,SendMessageOptions.DontRequireReceiver);
		}
	}
	...
	{
		Camera.main.SendMessage("FinishWatchingVideo",true,SendMessageOptions.DontRequireReceiver);
