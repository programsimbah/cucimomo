...
//			PopUpSpecialOffer = GameObject.Find("PopUps/PopUpSpecialOffer");
		...
		if(Application.loadedLevelName=="MainScene" && bFirstLoadMainScene)
		{
...
//					dailyaReward.gameObject.SetActive(false);
	...
	public void ClosePopUpMenu(GameObject menu)
	{
		...
		SoundManager.Instance.Play_PopUpHide(.4f);
		if(Application.loadedLevelName != "Room") EscapeButtonManager.EscapeButonFunctionStack.Pop();
	}
